// Leaderboard.jsx — Slide-in side panel showing the top-N dogs by total
// score. Rows for the local player get a highlighted "self" style. The
// list is fully controlled by the parent (passed in via `rows`), which
// keeps it in sync with the live `leaderboard_update` socket event.

import { playClick } from "../../utils/soundFx";
import "../../styles/popups.css";

const DOG_ICON = { husky: "🐺", pug: "🐶", shibainu: "🦊" };

export function Leaderboard({ rows = [], selfWallet, onClose }) {
  return (
