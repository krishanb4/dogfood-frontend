...
// Demo wallet addresses — share these across browser tabs/devices to test
// multi-user joins before real wallet-connect is wired up.
const DEMO_WALLETS = [
...
export function DogSelector({ onSelect }) {
