// GoalCompletePopup.jsx — Brief centred celebration when one or more
// daily goals complete. Plays fanfare (or perfect-day fanfare for 3/3)
// and emits a quick burst of CSS-only confetti. Auto-closes after the
// animation completes; parent owns the lifetime.
...
export function GoalCompletePopup({ event, onDone }) {
  // event: { completedGoals: [...], awardedTokens, perfectDay }
  useEffect(() => {
    if (!event) return;
