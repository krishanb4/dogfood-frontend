// CountdownTimer.jsx — Counts down to the next UTC midnight reset.
// Drives the "Goals reset in HH:MM:SS" indicator in the top bar.
...
export function CountdownTimer() {
  ...
  const isUrgent = total <= 600; // last 10min
