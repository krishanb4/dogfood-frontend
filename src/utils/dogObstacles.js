// dogObstacles.js — Shared dog-position registry used by the player's
// collision code. Each wandering dog writes its world position into this
// map every frame (from useDogWander); Player.jsx queries the map to see
...
const _positions = new Map(); // wallet → THREE.Vector3 (world position)

const DOG_RADIUS = 1.0;       // collision radius for any dog

export function reportDogPosition(wallet, source) {
...
export function clearDogPosition(wallet) {
...
export function dogBlocksAt(x, z, r) {
